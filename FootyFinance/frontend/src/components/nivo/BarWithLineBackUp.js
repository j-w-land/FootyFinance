...
export default function BarWithLine(props) {
  ...
  for (const item in dataFormattedLeftAxis) {
    keysVals.push(dataFormattedLeftAxis[item].id);
  }
    ...
    >
      ...
      >
        <ResponsiveBar
          ...
          keys={keysVals} //{setUp[setUp.axisBottom["items"]]}// {["hot dog", "burger", "sandwich", "kebab", "fries", "donut"]} //{setUp[setUp.axisBottom["items"]]}//
